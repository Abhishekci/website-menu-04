...
$(document).ready(function () {
    $('#candidate-type').change(function () {
        ...
        $('#inService-no, #inService-yes, #exservice-no, #exservice-yes, #ex-servicerelation').prop('disabled', false).prop('checked', false);
        ...
        if ($(this).val() === 'option1') {
            ...
            $('#ex-servicerelation').prop('checked', false).prop('disabled', false);
